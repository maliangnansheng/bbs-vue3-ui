      ...
      <div class="header-right-content">
        ...
        <div class="header-search">
          <a-space direction="vertical">
            <a-input-search v-model:value="searchContentTemp" :placeholder="$t('common.searchPlaceholder')"
        ...
        <div class="header-item badge-container" v-if="$store.state.isLogin">
          <a-dropdown class="dropdown" v-model:visible="visible" overlayClassName="header-message-box"
...
export default {
  components: {MessageBox, Login, Register, MobileResetPassword, EmailResetPassword, IndexMenu, IndexSider,CheckOutlined,GlobalOutlined},
