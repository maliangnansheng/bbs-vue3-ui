<template>
  <div id="write-article">
    <div class="left">
      <a-input class="write-item" v-model:value="articleTitle" :placeholder="$t('common.enterArticleTitle')" size="large"/>
      <a-popover v-model:value="visible" :title="$t('common.releaseArticle')" trigger="click" placement="bottomRight">
        <template #content>
...
export default {
  components: {ArticleBasicInfo, Login, Register,CheckOutlined,},
